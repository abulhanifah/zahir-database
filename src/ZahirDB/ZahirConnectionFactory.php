...
use Firebird\ConnectionFactory as BaseConnectionFactory;
...
use ZahirDB\Firebird\FirebirdConnection;
use ZahirDB\MySql\MySqlConnection;

class ZahirConnectionFactory extends BaseConnectionFactory {
